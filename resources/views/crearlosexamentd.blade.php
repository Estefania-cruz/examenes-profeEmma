...
@section('titulo')
	<title>Administrador | Realizar los examenes</title>
@endsection
              	...
              	<div class="card-body">
                	<div class="row">
                  		<div class="col-md-12">
                            ...
                            <hr>
                    				<div class="col-12">
                    					<button type="submit" class="btn btn-success w-100">Elaborar examen</button>
                    				</div>
                    			</form>
                    		</div>
                  		</div>
                        ...
                        <div class="col">
                          <form action="{{ route('admin.examen.preguntas') }}" method="POST">
                            ...
                            <button class="btn btn-primary" type="button" id="addPregunta">
                             Poner mas preguntas para contestar
                            </button>
                            <hr>
                            <div class="col-12">
                              <button type="submit" class="btn btn-success w-100">Poner mas preguntas</button>
                            </div>
                          </form>
                        </div>
                      </div>
